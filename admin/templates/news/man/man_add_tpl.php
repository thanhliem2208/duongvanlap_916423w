    ...
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="<?= $colRight ?>">
                ...
                <?php } ?>
                <?php if (isset($config['news'][$type]['images_1']) && $config['news'][$type]['images_1'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        <div class="card-header">
                            <h3 class="card-title">Hình ảnh <?= $config['news'][$type]['title_main'] ?></h3>
                            <div class="card-tools">
                        ...
                        <div class="card-body">
                            ...
                            $photoDetail1['dimension'] = "Width: " . $config['news'][$type]['width_1'] . " px - Height: " . $config['news'][$type]['height_1'] . " px (" . $config['news'][$type]['img_type'] . ")";
        ...
        <?php if (isset($config['news'][$type]['seo']) && $config['news'][$type]['seo'] == true) { ?>
            ...
            <?php } ?><?php if (isset($config['news'][$type]['schema']) && $config['news'][$type]['schema'] == true) { ?>
            <div class="card card-primary card-outline text-sm">
                <div class="card-header">
