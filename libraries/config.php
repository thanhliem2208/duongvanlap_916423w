<?php
	...
	/* Cấu hình coder */
	define('NN_CONTRACT', '916423w');
	define('NN_AUTHOR', 'nguyenliem.nina@gmail.com');

	/* Cấu hình chung */
	$config = array(
		'author' => array(
			'name' => 'Nguyễn Thanh Liêm',
			'email' => 'nguyenliem.nina@gmail.com',
			'timefinish' => '18/04/2023'
		),
		'arrayDomainSSL' => array(),
		'database' => array(
			'server-name' => $_SERVER["SERVER_NAME"],
			'url' => '/2023/thang7/duongvanlap_916423w/',
			'type' => 'mysql',
			'host' => 'localhost',
			'username' => 'root',
			'password' => '',
			'dbname' => 't7_duongvanlap',
			'port' => 3306,
			'prefix' => 'table_',
			'charset' => 'utf8mb4'
		),
		...
		'googleAPI' => array(
			'recaptcha' => array(
				...
				'sitekey' => '6LfGi4MgAAAAAHZqVr66HsJ6v8sa_3McHXRITatN',
				'secretkey' => '6LfGi4MgAAAAAAMHmKcHXEFhdNSZacCYddVA84WZ'
			)
		),
		'oneSignal' => array(
			'active' => false,
		...
		'license' => array(
			'version' => "7.1.0",
			'powered' => "nguyenliem.nina@gmail.com"
		)
	);
